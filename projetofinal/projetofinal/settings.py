...
SECRET_KEY = 'django-insecure-yw101y*0&q34ps^h2%18ntpmb_9zdx3)x1qp!i4#n5&*$!m@zw'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Base de Dados Dúvida Legal",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Dúvida Legal",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Dúvida Legal",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "base/logoperfil.png",
    ...
    "welcome_sign": "Bem Vindo ao Dúvida Legal",
...
MATERIAL_ADMIN_SITE = {
    ...
    #'PROFILE_BG':  'base/logoperfil.png',  # Admin site profile background (path to static should be specified)
